  ...
  return (
    <main>
      <aside className="max-w-[104px] bg-[#202636] h-screen fixed">
        ...
        <div className="text-5xl text-white flex justify-center bg-[#383E4C] py-3 ">
          <FiDatabase />
        </div>
      </aside>
      ...
      <article className="bg-[#151924]">
        ...
        <div className="grid grid-cols-3  gap-12 mx-12">
          <div className="col-span-2  ml-[104px] rounded-lg mb-12">
            ...
            <div className="">
              {pokemon_data.map((data,index) => (
                <PokemonDetails data={data} key={index} />
              ))}
          ...
          <div className="col-span-1 rounded-md flex flex-col h-fit bg-[#202636]">
            ...
            <div className="mx-3 mb-4">
              <input
                tyep="text"
                className="h-[45px] w-full bg-[#333c55] rounded-md pl-3 text-white "
